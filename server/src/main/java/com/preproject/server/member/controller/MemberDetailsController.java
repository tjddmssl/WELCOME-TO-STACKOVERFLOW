...
//        return new ResponseEntity(new ResponseDto<>(result), HttpStatus.OK);
        ...
        strings.add("JAVA");
        strings.add("Spring Boot");
        Page<MemberDetailQuestionDto> memberPage = new PageImpl<>(List.of(new MemberDetailQuestionDto(1L,"test",strings,1L,1L,LocalDateTime.now()),new MemberDetailQuestionDto(2L,"test",strings,2L,1L,LocalDateTime.now()),new MemberDetailQuestionDto(3L,"test",strings,1L,1L,LocalDateTime.now())), PageRequest.of(0, 10), 3);
...
//        return new ResponseEntity(new ResponseDto<>(result), HttpStatus.OK);
        ...
        Page<MemberDetailAnswerDto> memberPage = new PageImpl<>(List.of(new MemberDetailAnswerDto(1L, "content", 1L, LocalDateTime.now()), new MemberDetailAnswerDto(2L, "content", 1L, LocalDateTime.now())), PageRequest.of(0, 10), 3);
        return new ResponseEntity(new ResponseDto<>(memberPage),HttpStatus.OK);
    }
